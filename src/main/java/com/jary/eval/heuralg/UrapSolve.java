...
public class UrapSolve{
    ...
    private static void PSOAlgSolve() throws Exception {
        int instanceNo = 1;
        int runtime = 10;
        Siap problem = Siap.generateProblem(instanceNo);
        PSOAlg alg = null;
        ...
        *//************ 统计结果 *************//*
        ...
        Particle best = null, worst = null;
        for(int i=0;i<results.size();i++){
            Particle sol = results.get(i);
            sum += sol.getValue();
    ...
    private static void FADEAlgSolve() throws Exception {
        int instanceNo = 1;
        int runtime = 10;
        Siap problem = Siap.generateProblem(instanceNo);
        FADEAlg alg = null;
        ...
        *//************ 统计结果 *************//*
        ...
        FireSpark best = null, worst = null;
        for(int i=0;i<results.size();i++){
            FireSpark sol = results.get(i);
            sum += sol.getValue();
    ...
    private static void DNSPSOAlgSolve() throws Exception {
        int instanceNo = 1;
        int runtime = 10;
        Siap problem = Siap.generateProblem(instanceNo);
        DNSPSOAlg alg = null;
    ...
    private static void DEDNSPSOAlgSolve() throws Exception {
        int instanceNo = 1;
        int runtime = 10;
        Siap problem = Siap.generateProblem(instanceNo);
